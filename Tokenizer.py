...
def tokenize(filPth):
    try:  
        with open(filPth, 'r', encoding = 'utf-8-sig') as f:    # O(1) In worst case this is executed so we include
...
#    Each component is enumerated in the comments below
def computeWordFrequencies(tokListGen):
...
#    Each component is enumerated in the comments below
def printWordFrequencies(freqMap):
